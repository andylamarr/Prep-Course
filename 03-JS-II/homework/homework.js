...
function esEntero(numero) { //DUDA1
...
function fizzBuzz(numero) { //DUDA2
...
function operadoresLogicos(num1, num2, num3) { //DUDA3
...
function tieneTresDigitos(numero){//DUDA
